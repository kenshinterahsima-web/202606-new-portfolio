...
<main style="padding-top: 7rem;">
    ...
    <div class="c-page-hero">
        <div class="inner">
            <span class="c-page-hero-label">Privacy Policy</span>
            <h1 class="c-page-hero-title">プライバシーポリシー</h1>
        </div>
    </div>
    ...
    <section class="section">
        <div class="inner">
            <div class="pp-content">
                ...
                <p class="pp-lead">Archet Design.（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>

                <div class="pp-section">
                    <h2 class="pp-heading">第1条（個人情報）</h2>
                ...
                <div class="pp-section">
                    <h2 class="pp-heading">第2条（個人情報の収集方法）</h2>
                ...
                <div class="pp-section">
                    <h2 class="pp-heading">第3条（個人情報を収集・利用する目的）</h2>
                ...
                <div class="pp-section">
                    <h2 class="pp-heading">第4条（利用目的の変更）</h2>
                ...
                <div class="pp-section">
                    <h2 class="pp-heading">第5条（個人情報の第三者提供）</h2>
                    ...
                    <ul class="pp-list pp-list--nested">
                ...
                <div class="pp-section">
                    <h2 class="pp-heading">第6条（個人情報の開示）</h2>
                ...
                <div class="pp-section">
                    <h2 class="pp-heading">第7条（個人情報の訂正および削除）</h2>
                ...
                <div class="pp-section">
                    <h2 class="pp-heading">第8条（個人情報の利用停止等）</h2>
                ...
                <div class="pp-section">
                    <h2 class="pp-heading">第9条（プライバシーポリシーの変更）</h2>
                ...
                <div class="pp-section">
                    <h2 class="pp-heading">第10条（お問い合わせ窓口）</h2>
